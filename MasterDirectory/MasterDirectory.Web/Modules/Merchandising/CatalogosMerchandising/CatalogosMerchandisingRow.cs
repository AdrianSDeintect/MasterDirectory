...
public sealed class CatalogosMerchandisingRow : Row<CatalogosMerchandisingRow.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Descripcion"), Column("descripcion"), Size(250), QuickSearch]
    ...
    [DisplayName("DescripcionClave"), Concat("t0.IdClave", "' - '", "t0.Descripcion"), QuickSearch, NameProperty]
    public string DescripcionClave
    {
        get => fields.DescripcionClave[this];
        set => fields.DescripcionClave[this] = value;
    }
    ...
    public class RowFields : RowFieldsBase
    {
        ...
        public StringField DescripcionClave;
