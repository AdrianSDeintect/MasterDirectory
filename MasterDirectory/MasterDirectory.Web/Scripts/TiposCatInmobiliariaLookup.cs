namespace MasterDirectory.Web.Scripts
{
    ...
    [LookupScript("TiposCatInmobiliarioLookup", Permission = "*")]
    public class TiposCatInmobiliariaLookup : RowLookupScript<TipoCatalogosRow>
    {
        private static TipoCatalogosRow.RowFields fld => TipoCatalogosRow.Fields;

        public TiposCatInmobiliariaLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
