namespace MasterDirectory.Web.Scripts
{
    ...
    [LookupScript("TiposCatDigitalLookup", Permission = "*")]
    public class TiposCatDigitalLookup : RowLookupScript<TipoCatalogosRow>
    {
        private static TipoCatalogosRow.RowFields fld => TipoCatalogosRow.Fields;

        public TiposCatDigitalLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
