namespace MasterDirectory.Web.Scripts
{
    ...
    [LookupScript("TiposCatComercialesLookup", Permission = "*")]
    public class TiposCatComercialesLookup : RowLookupScript<TipoCatalogosRow>
    {
        private static TipoCatalogosRow.RowFields fld => TipoCatalogosRow.Fields;

        public TiposCatComercialesLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
