namespace MasterDirectory.Web.Scripts
{
    ...
    [LookupScript("TiposCatUltimaMillaLookup", Permission = "*")]
    public class TiposCatUltimaMillaLookup : RowLookupScript<TipoCatalogosRow>
    {
        private static TipoCatalogosRow.RowFields fld => TipoCatalogosRow.Fields;

        public TiposCatUltimaMillaLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
