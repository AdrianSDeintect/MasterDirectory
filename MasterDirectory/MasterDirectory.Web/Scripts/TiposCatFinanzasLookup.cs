namespace MasterDirectory.Web.Scripts
{
    ...
    [LookupScript("TiposCatFinanzasLookup", Permission = "*")]
    public class TiposCatFinanzasLookup : RowLookupScript<TipoCatalogosRow>
    {
        private static TipoCatalogosRow.RowFields fld => TipoCatalogosRow.Fields;

        public TiposCatFinanzasLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
