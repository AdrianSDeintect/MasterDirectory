namespace MasterDirectory.Web.Scripts
{
    ...
    [LookupScript("TiposCatConsultoriosLookup", Permission = "*")]
    public class TiposCatConsultoriosLookup : RowLookupScript<TipoCatalogosRow>
    {
        private static TipoCatalogosRow.RowFields fld => TipoCatalogosRow.Fields;

        public TiposCatConsultoriosLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
